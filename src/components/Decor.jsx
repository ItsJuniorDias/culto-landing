...
/* Two blurred red gradient blooms that breathe. Disabled under reduced motion. */
export function Rays() {
  ...
  return (
    <div aria-hidden="true" className="pointer-events-none absolute inset-0 z-0 overflow-hidden">
      ...
      <motion.div className={`${common} blur-[10px]`} style={bottom} {...loop(11)} />
    </div>
  )
}
...
export function Burst({ pos = 'tl', full = true }) {
  const reduce = useReducedMotion()
  const paths = full
    ? ['M0 0L130 28', 'M0 0L130 0', 'M0 0L130 64', 'M0 0L130 110', 'M0 0L28 130', 'M0 0L0 130', 'M0 0L64 130', 'M0 0L110 130']
    : ['M0 0L130 28', 'M0 0L130 0', 'M0 0L130 64', 'M0 0L28 130', 'M0 0L0 130', 'M0 0L64 130']
