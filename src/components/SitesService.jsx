...
function Showcase() {
  ...
  return (
    ...
    >
      ...
      >
        <span className="font-util absolute -left-px -top-px z-20 bg-blood px-3.5 py-[7px] text-[11px] font-bold uppercase tracking-[0.16em] text-bone">
          {s.badge}
        </span>
        ...
        <div className="flex items-center gap-3 border-b border-line bg-panel-2 px-4 py-3">
          ...
          <span className="font-util ml-2 inline-flex items-center gap-2 rounded-sm border border-line bg-ink/60 px-3 py-1 text-[11px] tracking-[0.08em] text-ash">
            <svg viewBox="0 0 24 24" className="h-3 w-3 fill-none stroke-ash" strokeWidth="2">
        ...
        <div className="relative aspect-[16/11] overflow-hidden bg-[radial-gradient(120%_90%_at_50%_0%,#FFFDF6_0%,#FBF7EC_60%,#F3ECDA_100%)]">
          ...
          <div
            ...
            style={{
              backgroundImage: 'radial-gradient(circle, rgba(90,79,207,0.18) 1px, transparent 1.4px)',
          ...
          <div className="flex h-full flex-col items-center justify-center px-6 pt-6 text-center">
            ...
            <p className="mt-2 max-w-[26ch] text-[12.5px] leading-snug text-[#6A628C]">{s.sub}</p>
      ...
      <motion.div variants={reduce ? undefined : fadeUp}>
        ...
        <p className="mt-4 max-w-[46ch] text-[15.5px] text-ash">
          Um exemplo de entrega ponta a ponta: da landing ao funil de conversão, com atribuição
          server-side funcionando mesmo com as travas da Kids Category da Apple.
        </p>
